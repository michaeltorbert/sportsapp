...
export default function Home() {
  ...
  const protectedBoards = useMemo(() => ({ daily: protectDukeBoard(boards.daily, duke.prefs), acc: protectDukeBoard(boards.acc, duke.prefs), top25: protectDukeBoard(boards.top25, duke.prefs) }), [boards, duke.prefs]);
  ...
  const qualifying = (f: Filter) => viewGames(protectedBoards[scoreboardScope(f)], f, hideFinals, focusedGame);
