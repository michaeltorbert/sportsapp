...
// Selected ESPN week fully covers September 4–7 in Eastern time.
export function cdnFeed(events = []) {
  return { content: { sbData: { events, season: { type: 2 }, week: { number: 1 },
    leagues: [{ calendar: [{ value: "2", entries: [{ value: "1", startDate: "2026-08-22T07:00Z", endDate: "2026-09-08T06:59Z" }] }] }],
  } } };
}
