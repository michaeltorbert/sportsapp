...
export type Game = { id: string; date: string; timeValid: boolean; neutralSite?: boolean; state: "live" | "delayed" | "upcoming" | "final" | "other"; status: string; period: number; clock: number; clockKnown?: boolean; intermission?: boolean; halftime?: boolean; pregameLine?: PregameLine; pregameEvidenceInvalid?: boolean; alertExpectation?: AlertExpectation; started: boolean; teams: [Team, Team]; broadcast: string; broadcasts?: string[]; possession: string | null; downDistance: string; redZone: boolean; url: string; retainedCategories?: Categories; lastActiveClose?: boolean };
